...
进入 github 仓库，https://github.com/qvietdpzai/Btnlaucher2-pc-template，点击 Use this template 来创建启动器仓库
...
然后请打开 btnlauncher2 加载你的开发环境，
在 托盘 中找到 btnlauncher2 图标，右键选择`浏览第三方启动器界面`
...
A：
在回答这个问题之前，你需要确保你大概了解 btnlauncher2 的实例 (instance) 机制，并不复杂，详情请看[这个文档](https://btnlauncher2.app/zh/faq)）
