...
Перейдіть до репозиторію github, https://github.com/qvietdpzai/Btnlaucher2-pc-template, натисніть Use this template, щоб створити репозиторій лаунчера
...
Потім відкрийте btnlauncher2 для завантаження вашого середовища розробки,
Знайдіть іконку btnlauncher2 в системному треї, клацніть правою кнопкою миші та виберіть `Переглянути інтерфейс стороннього лаунчера`
...
A:
Перш ніж відповісти на це питання, вам потрібно розуміти механізм екземплярів (instance) Btnlauncher2, це не складно, деталі дивіться в [цій документації](https://btnlauncher2.app/zh/faq))
...
```ts
import { InstallServiceKey } from '@btnlauncher2/runtime-api'
