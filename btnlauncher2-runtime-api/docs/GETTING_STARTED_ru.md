...
Перейдите в репозиторий github, https://github.com/qvietdpzai/Btnlaucher2-pc-template, нажмите Use this template, чтобы создать репозиторий лаунчера
...
Затем откройте btnlauncher2 для загрузки вашего окружения разработки,
Найдите иконку btnlauncher2 в системном трее, щелкните правой кнопкой мыши и выберите `Просмотреть интерфейс стороннего лаунчера`
...
A:
Прежде чем ответить на этот вопрос, вам нужно понимать механизм экземпляров (instance) Btnlauncher2, это не сложно, детали смотрите в [этой документации](https://btnlauncher2.app/zh/faq))
