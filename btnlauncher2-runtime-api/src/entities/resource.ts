import { type Resource, type ResourceActionTuple, type ResourceError, type ResourceErrorActionTuple, type UpdateResourcePayload } from '@btnlauncher2/resource'
...
export class ResourceState {
   ...
   * `@btnlauncher2/resource/ResourcesState.ts` for the contract — the runtime
