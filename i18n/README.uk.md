...
Відвідайте [оффіційну сторінку](https://btnlauncher2.app) щоб завантажити програму!
...
Для розробника локалізації i18n, будь ласка, перейдіть за посиланням [Початок роботи з локалізацією](https://docs.btnlauncher2.app/en/guide/i18n)
