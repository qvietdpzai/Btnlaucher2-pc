...
[![npm version](https://img.shields.io/npm/v/@btnlauncher2/curseforge.svg)](https://www.npmjs.com/package/@btnlauncher2/curseforge)
[![Downloads](https://img.shields.io/npm/dm/@btnlauncher2/curseforge.svg)](https://npmjs.com/@btnlauncher2/curseforge)
[![Install size](https://packagephobia.now.sh/badge?p=@btnlauncher2/curseforge)](https://packagephobia.now.sh/result?p=@btnlauncher2/curseforge)
...
```ts
import { CurseforgeV1Client, SearchOptions } from '@btnlauncher2/curseforge'
