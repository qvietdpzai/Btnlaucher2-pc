...
import { InstalledAppManifest, Settings } from '@btnlauncher2/runtime-api'
import { Client, LauncherAppController } from '@btnlauncher2/runtime/app'
import { Logger } from '@btnlauncher2/runtime/infra'
import { kSettings } from '@btnlauncher2/runtime/settings'
...
export class ElectronController implements LauncherAppController {
  ...
  async startMigrate() {
    ...
    const browser = new BrowserWindow({
      title: 'Btnlauncher2 Launcher Migrate',
      frame: false,
      resizable: false,
      width: 600,
      height: 400,
  ...
  async createBrowseWindow() {
    ...
    const browser = new BrowserWindow({
      title: 'Btnlauncher2 Launcher Browser',
      frame: false,
      transparent: true,
      resizable: false,
      width: 860,
    ...
    return new Promise<string>((resolve, reject) => {
      ...
      const browser = new BrowserWindow({
        ...
        webPreferences: {
          ...
          sandbox: true,
          partition: 'persist:btnlauncher2-microsoft-login',
        },
        show: false,
      })
