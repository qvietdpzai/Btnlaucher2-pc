...
import type { ServiceChannels, ServiceKey, SharedState } from '@btnlauncher2/runtime-api'
import { contextBridge, ipcRenderer } from 'electron'
import EventEmitter from 'events'

// NOTE: this preload is intentionally a "dumb pipe". It does NOT import the
// state classes from `@btnlauncher2/runtime-api` (doing so drags the whole command
...
// (see btnlauncher2-keystone-ui/src/composables/syncableState.ts). The renderer also
