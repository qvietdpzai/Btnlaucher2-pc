import { queryStatus } from '@btnlauncher2/client'
import { createFailureServerStatus, PingServerOptions, protocolToMinecraft, ServerStatusService as IServerStatusService, ServerStatusServiceKey } from '@btnlauncher2/runtime-api'
