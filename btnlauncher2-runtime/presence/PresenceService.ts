import { Client, type SetActivity } from '@btnlauncher2/discord-rpc'
import { type PresenceService as IPresenceService, type SharedState, PresenceServiceKey, Settings } from '@btnlauncher2/runtime-api'
