import { AddClosetOptions, ClosetResponse, GetClosetOptions, ListSkinResult, LittleSkinCharacter, RenameClosetOptions, SetCharacterNameOptions, SetCharacterTextureOptions } from '@btnlauncher2/runtime-api'
