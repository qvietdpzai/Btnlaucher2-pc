import { installZuluJava as installerInstallZuluJava, selectZuluJRE, type ZuluJRE } from '@btnlauncher2/installer'
...
// Re-export types and functions from @btnlauncher2/installer
export { installZuluJava, selectZuluJRE, type ZuluJRE } from '@btnlauncher2/installer'
...
export async function setupZuluCache(app: LauncherApp) {
  ...
  const response = await app.fetch('https://raw.githubusercontent.com/Voxelum/btnlauncher2-static-resource/refs/heads/main/zulu.json', {
    headers: {
