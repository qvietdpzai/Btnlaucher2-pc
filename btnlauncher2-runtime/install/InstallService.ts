import { checksum, LibraryInfo, MinecraftFolder, ResolvedLibrary, Version } from '@btnlauncher2/core'
import { download, type DownloadBaseOptions } from '@btnlauncher2/file-transfer'
import {
  AnyTracker,
  AssetsOptions,
...
import { waitProcess } from '@btnlauncher2/installer/utils'
import {
  Task,
  DiagnoseOptions,
    ...
    for (const java of validJavaPaths) {
      try {
        ...
        if (err instanceof Error) {
          ...
          // download, AV stripping). `@btnlauncher2/installer.installForge` opens it
