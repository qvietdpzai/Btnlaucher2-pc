import { LibraryInfo, Version } from '@btnlauncher2/core'
import { ElyByServiceKey, type ElyByService as IElyByService } from '@btnlauncher2/runtime-api'
...
export class ElyByService extends AbstractService implements IElyByService {
  ...
  async #init() {
    ...
    const resp = await this.app.fetch('https://api.btnlauncher2.app/elyby/authlib', {
      headers: etag ? {
        'If-None-Match': etag,
      } : {},
    })
