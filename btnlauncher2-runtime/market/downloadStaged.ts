import { DownloadOptions, download } from '@btnlauncher2/file-transfer'
 ...
 *
 * Why this helper lives here (and NOT in @btnlauncher2/file-transfer):
 ...
 * - Keeping the rename / cleanup logic out of @btnlauncher2/file-transfer
