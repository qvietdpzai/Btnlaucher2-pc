            ...
            <v-card min-width="360" width="420" max-width="90vw" class="overflow-y-auto" style="max-height: 60vh">
              ...
              <template v-if="modrinth">
                ...
                <div class="filter-subheader flex items-center">
                  <v-icon size="16" class="mr-1">btnlauncher2:modrinth</v-icon>
        ...
        <template v-if="curseforge || modrinth">
          ...
          <span v-else class="flex flex-wrap gap-2 px-2" v-roving-tabindex role="toolbar">
            <v-btn
              ...
              variant="text"
            >
              <v-icon> btnlauncher2:modrinth </v-icon>
            </v-btn>
            <v-btn
              v-if="curseforge"
              icon
              ...
              variant="text"
            >
              <v-icon class="mt-0.5" :size="30"> btnlauncher2:curseforge </v-icon>
            </v-btn>
          </span>
...
import { CollectionContentType, CollectionProvider } from '@btnlauncher2/runtime-api'
...
const iconMapping = {
  forge: 'btnlauncher2:forge',
  fabric: 'btnlauncher2:fabric',
  quilt: 'btnlauncher2:quilt',
  optifine: 'btnlauncher2:optifine',
  neoforge: 'btnlauncher2:neoForged',
  iris: 'btnlauncher2:iris',
  oculus: 'btnlauncher2:oculus',
