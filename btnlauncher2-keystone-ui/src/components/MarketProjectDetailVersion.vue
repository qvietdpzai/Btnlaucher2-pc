...
const loaders = computed(() => props.version.loaders.map(l => {
  if (l.toLowerCase() === 'vanilla') return { icon: 'btnlauncher2:minecraft', loader: l }
  if (l.toLowerCase() === 'forge') return { icon: 'btnlauncher2:forge', loader: l }
  if (l.toLowerCase() === 'fabric') return { icon: 'btnlauncher2:fabric', loader: l }
  if (l.toLowerCase() === 'quilt') return { icon: 'btnlauncher2:quilt', loader: l }
  if (l.toLowerCase() === 'neoforge') return { icon: 'btnlauncher2:neoForged', loader: l }
  if (l.toLowerCase() === 'iris') return { icon: 'btnlauncher2:iris', loader: l }
  if (l.toLowerCase() === 'optifine') return { icon: 'btnlauncher2:optifine', loader: l }
  return { loader: l }
}))
