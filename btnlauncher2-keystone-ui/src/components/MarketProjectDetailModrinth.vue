...
import { SearchResultHit } from '@btnlauncher2/modrinth'
import { ProjectMapping, ProjectMappingServiceKey } from '@btnlauncher2/runtime-api'
...
const props = defineProps<{
  ...
  collectionContentType?: import('@btnlauncher2/runtime-api').CollectionContentType
}>()
  ...
  >
    <div>
      <v-btn
        ...
        variant="text"
      >
        <v-icon start>btnlauncher2:curseforge</v-icon>
        Curseforge
      </v-btn>
    </div>
  </Hint>
