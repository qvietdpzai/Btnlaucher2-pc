    ...
    <div class="mt-4 flex flex-col gap-3 items-center text-sm font-medium">
      ...
      >
        ...
        <div class="flex flex-col gap-1.5 pt-1">
          <a
            target="browser"
            href="https://btnlauncher2.app/en/guide/microsoft-login-issues"
          ...
          >
            <v-icon size="14">btnlauncher2:discord</v-icon>
      ...
      operations: [
        {
          ...
          icon: 'help_outline',
          handler() {
            window.open('https://btnlauncher2.app/en/guide/microsoft-login-issues', 'browser')
          },
        },
        {
          text: t('loginError.openDiscordSupport'),
          icon: 'btnlauncher2:discord',
          handler() {
