...
import type { AgentMarketProject, AgentMarketProjectListPresentation } from '@btnlauncher2/runtime-api'
import { InstanceModsServiceKey, InstanceResourcePacksServiceKey, InstanceShaderPacksServiceKey } from '@btnlauncher2/runtime-api'
...
const providerIcon = computed(() => props.presentation.source === 'modrinth' ? 'btnlauncher2:modrinth' : 'btnlauncher2:curseforge')
