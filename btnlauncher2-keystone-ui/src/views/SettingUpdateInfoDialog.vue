<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/qvietdpzai/Btnlaucher2-pc/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://btnlauncher2.app', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/qvietdpzai/Btnlaucher2-pc/releases', 'browser')
}
</script>
