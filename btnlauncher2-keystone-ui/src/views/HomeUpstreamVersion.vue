...
const getLoader = (loader: string) => {
  ...
  if (loader === 'forge') return 'btnlauncher2:forge'
  if (loader === 'fabric') return 'btnlauncher2:fabric'
  if (loader === 'neoforge') return 'btnlauncher2:neoForged'
  if (loader === 'quilt') return 'btnlauncher2:quilt'
  return ''
}
