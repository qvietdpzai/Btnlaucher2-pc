...
import { InstanceModsServiceKey } from '@btnlauncher2/runtime-api'
...
const modLoaderFilterItems = computed(() => {
  return [{
    icon: 'btnlauncher2:forge',
    text: 'Forge',
    value: 'forgeOnly',
  }, {
    icon: 'btnlauncher2:neoForged',
    text: 'NeoForge',
    value: 'neoforgeOnly',
  }, {
    icon: 'btnlauncher2:fabric',
    text: 'Fabric',
    value: 'fabricOnly',
  }, {
    icon: 'btnlauncher2:quilt',
    text: 'Quilt',
    value: 'quiltOnly',
  }]
})
