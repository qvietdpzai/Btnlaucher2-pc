  ...
  >
    ...
    >
      ...
      <v-icon
        ...
        size="small"
      >
        {{ (pack.modrinth || pack.modrinthProjectId) ? 'btnlauncher2:modrinth' : (pack.curseforge || pack.curseforgeProjectId) ? 'btnlauncher2:curseforge' : '' }}
      </v-icon>
    </template>
  </MarketItem>
</template>
...
import { BaseServiceKey, InstanceResourcePacksServiceKey, isCompatible } from '@btnlauncher2/runtime-api'
