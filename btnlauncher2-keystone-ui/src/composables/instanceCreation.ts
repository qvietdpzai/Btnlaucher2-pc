...
import { InstanceInstallServiceKey, InstanceResourcePacksServiceKey, InstanceSavesServiceKey, InstanceServiceKey, InstanceShaderPacksServiceKey, VersionMetadataServiceKey } from '@btnlauncher2/runtime-api'
import type { GameProfile } from '@btnlauncher2/user'
import { useLocalStorage } from '@vueuse/core'
import { InjectionKey, Ref, reactive } from 'vue'
import { kLatestMinecraftVersion } from './version'
import { useNotifier } from './notifier'
import { CreateInstanceOptions, Instance, InstanceData, InstanceFile } from '@btnlauncher2/instance'
