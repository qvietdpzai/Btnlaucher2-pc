...
import { Collection, Project } from '@btnlauncher2/modrinth'
import { Mod as CurseforgeMod } from '@btnlauncher2/curseforge'
import { CollectionContentType } from '@btnlauncher2/runtime-api'
