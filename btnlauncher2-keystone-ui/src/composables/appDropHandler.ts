...
import { Resource } from '@btnlauncher2/resource'
...
export function useAppDropHandler() {
  ...
  const iconMap: Record<string, string> = {
    mods: 'btnlauncher2:package',
    unclassified: 'question_mark',
    resourcepacks: 'btnlauncher2:zip',
    shaderpacks: 'btnlauncher2:zip',
    modpacks: 'btnlauncher2:package',
    saves: 'btnlauncher2:zip',
  }
  ...
  function getIcon(resource: Resource | undefined) {
    ...
    //   return 'btnlauncher2:curseforge'
    // }
    // if (resource?.metadata['modrinth-modpack']) {
    //   return 'btnlauncher2:modrinth'
    // }
    // if (resource?.metadata['mcbbs-modpack']) {
    //   return 'btnlauncher2:package'
    // }
    if (resource?.metadata.forge) {
      return 'btnlauncher2:forge'
    }
    if (resource?.metadata.fabric) {
      return 'btnlauncher2:fabric'
    }
